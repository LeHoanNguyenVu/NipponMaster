  ...
  return (
    <div className="max-w-[1280px] mx-auto p-6 md:p-8 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* SRS Card */}
        <div className="col-span-1 lg:col-span-8 bg-surface-container-lowest rounded-2xl p-6 md:p-8 border border-outline-variant shadow-sm relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="mt-8 flex items-center gap-4 relative z-10">
            <button 
              ...
              className="bg-primary text-white px-8 py-3 rounded-lg font-medium hover:bg-primary/90 transition-all shadow-sm flex items-center gap-2"
            >
        ...
        {/* Daily Goal */}
        <div className="col-span-1 lg:col-span-4 bg-surface-container-lowest rounded-2xl p-6 border border-outline-variant shadow-sm flex flex-col items-center justify-center">
        ...
        <div className="col-span-1 lg:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="bg-surface-container-lowest rounded-2xl p-5 border border-outline-variant shadow-sm flex flex-col">
        ...
        {/* Recent Activity */}
        <div className="col-span-1 lg:col-span-12 bg-surface-container-lowest rounded-2xl p-6 border border-outline-variant shadow-sm">
