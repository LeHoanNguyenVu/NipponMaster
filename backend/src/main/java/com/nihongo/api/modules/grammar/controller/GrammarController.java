...
public class GrammarController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getAll(
        ...
        PageResponse<Grammar> page = grammarService.getAll(pageable);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getByLevel(
            ...
            @AuthenticationPrincipal Long userId,
            @PageableDefault(size = 20) Pageable pageable) {
        PageResponse<Grammar> page = grammarService.getByLevel(level, pageable);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> search(
        ...
        PageResponse<Grammar> page = grammarService.searchWithFilters(keyword, level, pageable);
        return ResponseEntity.ok(ApiResponse.ok(wrapWithAccess(page, userId, level)));
    }
    ...
    private Map<String, Object> wrapWithAccess(PageResponse<Grammar> page, Long userId, User.JlptLevel level) {
